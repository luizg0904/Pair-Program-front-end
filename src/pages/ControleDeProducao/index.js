...
// Componente de Controle de Produção com navegação e informações sobre as operações de produção
const ProductionControl = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Conteúdo principal com opções específicas de produção */}
            <ScrollView style={styles.scrollView}>
                ...
                {/* Cartões para interação com as funções de produção */}
                <View style={styles.content}>
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('Irrigacao')}}>
                        <Icon name="water" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Irrigação</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('Colheita')}}>
                        <Icon name="sprout" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Colheita</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('ControleTemperatura')}}>
                        <Icon name="thermometer" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Controle de Temperatura</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
