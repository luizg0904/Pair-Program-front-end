...
// Componente de Gestão de Estoque com navegação entre diferentes seções
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.content}>
                    {/* Cartões interativos para diferentes funcionalidades de gestão de estoque */}
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('EstoqueProdutosAgricolas') }}>
                        <Icon name="warehouse" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Estoque de Produtos Agrícolas</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('MovimentacaoEstoque')  }}>
                        <Icon name="format-list-bulleted" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Movimentação de Estoques</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.card} onPress={() => {navigation.navigate('GestaoArmazenamento')  }}>
                        <Icon name="archive" size={45} color="#000" />
                        <Text style={styles.cardTitle}>Gestão de Armazenamento</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
